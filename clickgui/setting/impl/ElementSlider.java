 ...
 *  @author HeroCode
 */
public class ElementSlider extends Component {
	public boolean dragging;

	/*
	 * Konstrukor
	 */
	public ElementSlider(ModButton iparent, Setting iset) {
		parent = iparent;
		set = iset;
		dragging = false;
		super.setup();
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		 ...
		 * Den Text rendern
		 */
		Minecraft.getMinecraft().fontRendererObj.drawString(setstrg, x + 1, y + 2, 0xffffffff);
		Minecraft.getMinecraft().fontRendererObj.drawString(displayval, x + width - Minecraft.getMinecraft().fontRendererObj.getStringWidth(displayval), y + 2, 0xffffffff);
